...
const Index = () => {
  ...
  const getHeaderProps = () => {
    switch (currentView) {
      case 'create':
        return { showBackButton: true, onBack: handleBack, title: 'Create New ROSCA' };
      case 'join':
        return { showBackButton: true, onBack: handleBack, title: 'Join Existing ROSCA' };
      case 'dashboard':
        return { showBackButton: true, onBack: handleBack, title: 'ROSCA Dashboard' };
      default:
        return { title: 'Decentralized Rotating Savings and Credit Association' };
    }
  };
