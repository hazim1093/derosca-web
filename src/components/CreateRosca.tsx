      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="text-center">
            ...
            <p className="text-gray-600">Set your ROSCA parameters</p>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white rounded-xl py-3 font-medium transition-all duration-200"
            >
